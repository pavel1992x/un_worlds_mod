...
package net.mcreator.worldsmod.entity;
...
public class AmazonkaEntity extends WorldsModModElements.ModElement {
	public static EntityType entity = null;
	public AmazonkaEntity(WorldsModModElements instance) {
		super(instance, 83);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(72).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(0.6f, 1.8f))
						.build("amazonka").setRegistryName("amazonka");
		elements.entities.add(() -> entity);
		elements.items
				.add(() -> new SpawnEggItem(entity, -52480, -154, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("amazonka_spawn_egg"));
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(CustomEntity.class, renderManager -> {
			BipedRenderer customRender = new BipedRenderer(renderManager, new BipedModel(), 0.5f) {
				...
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("worlds_mod:textures/0536c26fca9006b4.png");
				}
			};
	...
	public static class CustomEntity extends AnimalEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			this.setItemStackToSlot(EquipmentSlotType.CHEST, new ItemStack(Items.DIAMOND_CHESTPLATE, (int) (1)));
			this.setItemStackToSlot(EquipmentSlotType.LEGS, new ItemStack(Items.DIAMOND_LEGGINGS, (int) (1)));
			this.setItemStackToSlot(EquipmentSlotType.FEET, new ItemStack(Items.DIAMOND_BOOTS, (int) (1)));
		...
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.villager.celebrate"));
		}
		...
		protected void registerAttributes() {
			...
			this.getAttribute(SharedMonsterAttributes.KNOCKBACK_RESISTANCE).setBaseValue(12.299999999999999D);
		}
		...
		public boolean isBreedingItem(ItemStack stack) {
			if (stack == null)
				return false;
			if (new ItemStack(ChestlinkItem.block, (int) (1)).getItem() == stack.getItem())
				return true;
			return false;
		}
	...
	private static class GlowingLayer<T extends Entity, M extends EntityModel<T>> extends LayerRenderer<T, M> {
		private static final ResourceLocation GLOW_TEXTURE = new ResourceLocation("worlds_mod:textures/0536c26fca9006b4.png");
