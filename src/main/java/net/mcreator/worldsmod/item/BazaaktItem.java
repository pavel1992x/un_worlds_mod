...
public class BazaaktItem extends WorldsModModElements.ModElement {
	@ObjectHolder("worlds_mod:bazaakt")
	public static final Item block = null;
	public BazaaktItem(WorldsModModElements instance) {
		super(instance, 11);
	}
	...
	public static class ItemCustom extends Item {
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			double z = entity.posZ;
			{
				...
				BazacreatProcedure.executeProcedure($_dependencies);
			}
			return ar;
		}
	}
