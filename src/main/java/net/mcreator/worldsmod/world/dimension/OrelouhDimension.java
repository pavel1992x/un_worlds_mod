...
import net.mcreator.worldsmod.block.OrelouhStoneBlock;
import net.mcreator.worldsmod.block.OrelouhFluidBlock;
...
public class OrelouhDimension extends WorldsModModElements.ModElement {
	@ObjectHolder("worlds_mod:orelouh")
	public static final ModDimension dimension = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public OrelouhDimension(WorldsModModElements instance) {
		super(instance, 149);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("orelouh"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("worlds_mod:orelouh")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("worlds_mod:orelouh"), dimension, null, true);
		}
		type = DimensionType.byName(new ResourceLocation("worlds_mod:orelouh"));
	}
		...
		public ChunkProviderModded(IWorld world, BiomeProvider provider) {
			super(world, provider, new OverworldGenSettings() {
				public BlockState getDefaultBlock() {
					return OrelouhStoneBlock.block.getDefaultState();
				}

				public BlockState getDefaultFluid() {
					return OrelouhFluidBlock.block.getDefaultState();
				}
			});
			...
			if (!biomesPatched) {
				for (Biome biome : this.biomes) {
					biome.addCarver(GenerationStage.Carving.AIR, Biome.createCarver(new CaveWorldCarver(ProbabilityConfig::deserialize, 256) {
						{
							carvableBlocks = ImmutableSet.of(OrelouhStoneBlock.block.getDefaultState().getBlock(),
