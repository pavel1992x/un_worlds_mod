...
public class P1dwDimension extends WorldsModModElements.ModElement {
	@ObjectHolder("worlds_mod:p_1dw")
	public static final ModDimension dimension = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public P1dwDimension(WorldsModModElements instance) {
		super(instance, 124);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("p_1dw"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("worlds_mod:p_1dw")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("worlds_mod:p_1dw"), dimension, null, true);
		}
		type = DimensionType.byName(new ResourceLocation("worlds_mod:p_1dw"));
	}
