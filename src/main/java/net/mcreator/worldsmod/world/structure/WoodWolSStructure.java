...
package net.mcreator.worldsmod.world.structure;
...
public class WoodWolSStructure extends WorldsModModElements.ModElement {
	public WoodWolSStructure(WorldsModModElements instance) {
		super(instance, 133);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 50000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("worlds_mod", "ww"));
						if (template == null)
							return false;
