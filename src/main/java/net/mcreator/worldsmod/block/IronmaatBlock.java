...
public class IronmaatBlock extends WorldsModModElements.ModElement {
	@ObjectHolder("worlds_mod:ironmaat")
	public static final Block block = null;
	public IronmaatBlock(WorldsModModElements instance) {
		super(instance, 143);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("ironmaat", "ironmaat", blockAt -> {
