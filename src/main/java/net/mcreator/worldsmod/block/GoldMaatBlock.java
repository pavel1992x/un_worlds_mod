...
public class GoldMaatBlock extends WorldsModModElements.ModElement {
	@ObjectHolder("worlds_mod:gold_maat")
	public static final Block block = null;
	public GoldMaatBlock(WorldsModModElements instance) {
		super(instance, 144);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("gold_maat", "gold_maat", blockAt -> {
