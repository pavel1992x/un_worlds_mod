...
public class DeranorFenceBlock extends WorldsModModElements.ModElement {
	@ObjectHolder("worlds_mod:deranor_fence")
	public static final Block block = null;
	public DeranorFenceBlock(WorldsModModElements instance) {
		super(instance, 32);
	}
