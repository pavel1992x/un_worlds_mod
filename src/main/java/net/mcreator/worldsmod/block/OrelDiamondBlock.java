...
public class OrelDiamondBlock extends WorldsModModElements.ModElement {
	@ObjectHolder("worlds_mod:orel_diamond")
	public static final Block block = null;
	public OrelDiamondBlock(WorldsModModElements instance) {
		super(instance, 153);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("orel_diamond", "orel_diamond", blockAt -> {
