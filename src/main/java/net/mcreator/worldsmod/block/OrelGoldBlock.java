...
public class OrelGoldBlock extends WorldsModModElements.ModElement {
	@ObjectHolder("worlds_mod:orel_gold")
	public static final Block block = null;
	public OrelGoldBlock(WorldsModModElements instance) {
		super(instance, 152);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("orel_gold", "orel_gold", blockAt -> {
