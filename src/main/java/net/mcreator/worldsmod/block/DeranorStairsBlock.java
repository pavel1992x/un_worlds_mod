...
public class DeranorStairsBlock extends WorldsModModElements.ModElement {
	@ObjectHolder("worlds_mod:deranor_stairs")
	public static final Block block = null;
	public DeranorStairsBlock(WorldsModModElements instance) {
		super(instance, 30);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("deranor_stairs");
		}
