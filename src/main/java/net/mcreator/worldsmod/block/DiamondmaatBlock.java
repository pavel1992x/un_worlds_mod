...
public class DiamondmaatBlock extends WorldsModModElements.ModElement {
	@ObjectHolder("worlds_mod:diamondmaat")
	public static final Block block = null;
	public DiamondmaatBlock(WorldsModModElements instance) {
		super(instance, 142);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.05f, 10f).lightValue(0));
			setRegistryName("diamondmaat");
		}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("diamondmaat", "diamondmaat", blockAt -> {
