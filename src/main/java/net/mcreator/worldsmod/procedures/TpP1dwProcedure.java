...
public class TpP1dwProcedure extends WorldsModModElements.ModElement {
	public TpP1dwProcedure(WorldsModModElements instance) {
		super(instance, 125);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure TpP1dw!");
			return;
		}
		Entity entity = (Entity) dependencies.get("entity");
		{
			...
			if (!_ent.world.isRemote && _ent instanceof ServerPlayerEntity) {
				DimensionType destinationType = P1dwDimension.type;
