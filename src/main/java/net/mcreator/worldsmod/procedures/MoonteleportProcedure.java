...
public class MoonteleportProcedure extends WorldsModModElements.ModElement {
	public MoonteleportProcedure(WorldsModModElements instance) {
		super(instance, 13);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure Moonteleport!");
			return;
		}
		Entity entity = (Entity) dependencies.get("entity");
		{
			...
			if (!_ent.world.isRemote && _ent instanceof ServerPlayerEntity) {
				DimensionType destinationType = MoonworldDimension.type;
