...
public class TpOrelouhProcedure extends WorldsModModElements.ModElement {
	public TpOrelouhProcedure(WorldsModModElements instance) {
		super(instance, 150);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure TpOrelouh!");
			return;
		}
		Entity entity = (Entity) dependencies.get("entity");
		{
			...
			if (!_ent.world.isRemote && _ent instanceof ServerPlayerEntity) {
				DimensionType destinationType = OrelouhDimension.type;
