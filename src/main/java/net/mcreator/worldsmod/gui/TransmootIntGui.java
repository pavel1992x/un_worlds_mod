...
public class TransmootIntGui extends WorldsModModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public TransmootIntGui(WorldsModModElements instance) {
		super(instance, 121);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("transmoot_int"));
	}
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("worlds_mod:textures/transmoot_int.png");
		@Override
