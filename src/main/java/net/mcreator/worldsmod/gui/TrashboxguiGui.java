...
import net.mcreator.worldsmod.procedures.TrashboxprProcedure;
...
public class TrashboxguiGui extends WorldsModModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public TrashboxguiGui(WorldsModModElements instance) {
		super(instance, 84);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("trashboxgui"));
	}
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("worlds_mod:textures/trashboxgui.png");
		@Override
